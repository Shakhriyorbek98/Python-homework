...
# 📊 Exercise 4: Bar chart for average grades by subject
...
# 📊 Exercise 4: Bar chart — employee distribution per department
df3['Department'].value_counts().plot(kind='bar', color='orange')
...
# ⚖️ Exercise 3: Average quantity ordered
